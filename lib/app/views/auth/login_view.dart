  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: Stack(
          children: [
            // Background fighter silhouette effect
          Positioned(
            top: -50,
            right: -50,
            child: Opacity(
              ...
              child: Center(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      // VS Style Logo Area - Inspired by FighterRec's VS badge
                      Container(
                        margin: const EdgeInsets.only(bottom: 20),
                        child: Column(
                          children: [
                            // Octagon-inspired logo container
                            Container(
                              width: 100,
                              height: 100,
                              decoration: BoxDecoration(
                        ...
                        child: ClipRRect(
                          ...
                          child: Material(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  // Demo Accounts Card - FighterRec Stats Style
                                  Container(
                                  ...
                                  // Login Button - FighterRec Action Style
                                  Obx(() => SizedBox(
                                  ...
                                  // Register Link - VS Style divider
                                  Row(
                                    children: [
                                      Expanded(
                                        child: Container(
